...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        for i in range(n):
            ...
            randIndices = random.randint(0,n-1)
            
            samples.append(XX[randIndices][:-1])
            labels.append(XX[randIndices][-1])
    ...
    def fitting(self):
        ...
        for i in range(self.num_trees):
            ...
            dataX = self.bootstraps_datasets[i]
            dataY = self.bootstraps_labels[i]
            tree.learn(dataX, dataY)        
    ...
    def voting(self, X):
        ...
        for record in X:
            ...
            if len(counts) == 0:
                ...
                vote = self.decision_trees[tree_index].classify(record)
                y = np.append(y, vote)
            else:
